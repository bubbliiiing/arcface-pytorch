...
if __name__ == "__main__":
    ...
    if True:
        ...
        for epoch in range(Init_Epoch, Epoch):
            ...
            fit_one_epoch(model_train, model, loss_history, optimizer, epoch, epoch_step, epoch_step_val, gen, gen_val, Epoch, Cuda, LFW_loader, lfw_eval_flag, save_period, save_dir)
